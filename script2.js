...
// Fetch CSV data and convert it to JSON and interate and plot markers based on the activity.
function addActivitiesToMap () {
    fetch('./CroydonReport.csv')
     ...
     if(activityCounter === 0 ) {
        alert('Sorry there were no activies found nearby, please type in a postcode within the Croydon area')
...
// Convert user Postcode to long and lat using FindThatPostCode API and run the plot marker function when user types in their post code. 
